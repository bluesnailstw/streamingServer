...
class QTAccessFile
{
    public:
        ...
        Bool16 AccessAllowedAdaptedRedis (QTSS_StandardRTSP_Params* inParams, char *userName, char**groupArray, UInt32 numGroups,
                                          QTSS_ActionFlags inFlags, Bool16 *outAllowAnyUserPtr, void *extraDataPtr = NULL
                                            );
        ...
        QTSS_Error AuthorizeRequestAdaptedRedis(QTSS_StandardRTSP_Params *inParams, Bool16 allowNoAccessFiles,
                                                QTSS_ActionFlags noAction, QTSS_ActionFlags authorizeAction,
                                                Bool16 *outAuthorizedPtr, Bool16 *outAllowAnyUserPtr = NULL);
